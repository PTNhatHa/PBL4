            ...
            <div class="pure-u-20-24">
                <div class="nav-child">
                    ...
                    <div class="button-head">
                        <input id="" class="button-head-hover" type="button" value="" style="background-image: url(<%=request.getContextPath() + "/img/Profile.png"%>);">
                        <input id="Home" type="button" value="" style="background-image: url(<%=request.getContextPath() + "/img/Home.png"%>);">
                    </div>
