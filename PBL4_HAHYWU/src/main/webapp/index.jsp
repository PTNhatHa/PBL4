            ...
            <div class="modal-content">
                <div class="ChangePassword headform">
                    ...
                    <div class="info-field">
                        ...
                        <input class="info-enter" type="email" id="changepw-email" placeholder="email" readonly>
                    </div>
                    <div class="info-field">
                        <p class="info-text">New password</p>
                        <input class="info-enter" type="password" id="npw" placeholder="new password">
                        <input type="button" class="showpw" id="shownpw" onmousedown="showPW('npw');" onmouseup="hidePW('npw');"></input>
                    </div>
                    <div class="info-field">
                        <p class="info-text">Confirm password</p>
                        <input class="info-enter" type="password" id="cpw" placeholder="confirm password">
                        <input type="button" class="showpw" id="showcpw" onmousedown="showPW('cpw');" onmouseup="hidePW('cpw');"></input>
                    </div>
                    <div class="info-field">
            ...
            <div class="OTPall">
	            ...
	            <div id="sendotpforchange" class="OTP" hidden>
	                ...
	                <div class="entermail" id="mail">
	                    ...
	                    <button class="Button-bl-wh" data-bs-target="" data-bs-toggle="modal" onclick="checkOTPforchange()">Send</button> <!-- THEM SU KIEN -->
	                </div>
